package com.basic.example.spring.business.aop;
...
//execution(* com.basic.example.spring.business.aop.HiByeService.*(..))
...
@ComponentScan(basePackages = { "com.basic.example.spring.business.aop" })
...
@Component
class MyAspect {
	@Before("execution(* com.basic.example.spring.business.aop.HiByeService.*(..))")
	...
	@AfterReturning(pointcut = "execution(* com.basic.example.spring.business.aop.HiByeService.*(..))", returning = "result")
